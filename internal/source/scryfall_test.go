...
func Test_ToSetsCards(t *testing.T) {
	input := []ScryfallCard{
		{
			CMC:              5.0,
			CollectorNumber:  "94",
		...
		},
		{
			...
			Name:             "Last Stand",
			Rarity:           Rare,
			ScryfallAPIURI:   "https://api.scryfall.com/cards/7dc3d054-6266-4ce0-89ed-f8b170794f2e",
			ScryfallId:       uuid.MustParse("7dc3d054-6266-4ce0-89ed-f8b170794f2e"),
			ScryfallOracleId: uuid.MustParse("4d2a465e-9ebd-4002-b6cd-e0eab08bad54"),
			ScryfallSetId:    uuid.MustParse("e4e00913-d08d-4899-86ea-5cf631e09ce0"),
			ScryfallWebURI:   "https://scryfall.com/card/apc/107/last-stand?utm_source=api",
			SetCode:          "apc",
			SetName:          "Apocalypse",
			TypeLine:         "Sorcery",
			Games: []string{
		...
		},
		{
			...
			LanguageCode:     Spanish,
			Name:             "Last Stand",
			PrintedName:      "Última Resistencia",
			Rarity:           Rare,
		...
		},
		{
			...
			Name:             "Last Stand",
			Rarity:           Rare,
			ScryfallAPIURI:   "https://api.scryfall.com/cards/170df4fb-cb9f-4132-8a80-fce458658c94",
			ScryfallId:       uuid.MustParse("170df4fb-cb9f-4132-8a80-fce458658c94"),
			ScryfallOracleId: uuid.MustParse("4d2a465e-9ebd-4002-b6cd-e0eab08bad54"),
			ScryfallSetId:    uuid.MustParse("e4e00913-d08d-4899-86ea-5cf631e09ce0"),
			ScryfallWebURI:   "https://scryfall.com/card/apc/107/de/letztes-gefecht-(last-stand)?utm_source=api",
			SetCode:          "apc",
			SetName:          "Apocalypse",
			TypeLine:         "Sorcery",
			Games: []string{
		...
		},
		{
			...
			Name:             "Bronze Horse",
			Rarity:           Uncommon,
			ScryfallAPIURI:   "https://api.scryfall.com/cards/0003b07e-0d6e-4844-93c7-3f1f6a7d8c4d",
			ScryfallId:       uuid.MustParse("0003b07e-0d6e-4844-93c7-3f1f6a7d8c4d"),
			ScryfallOracleId: uuid.MustParse("a7887b24-977d-4a40-bb30-4bf467e5dba6"),
			ScryfallSetId:    uuid.MustParse("d38a13b7-6615-4c89-be7d-3b4eaacf1875"),
			ScryfallWebURI:   "https://scryfall.com/card/me4/186/bronze-horse?utm_source=api",
			SetCode:          "me4",
	...
	expectedSetMap := map[uuid.UUID]Set{
	...
	expectedCardMap := map[uuid.UUID]CardPrinting{
		uuid.MustParse("4dea9d98-1bd4-4362-9768-67827dc28d3b"): {
			CollectorNumber:  "189",
			ColorIdentity:    "G",
			Colors:           "G",
			Language:         Spanish,
		...
		uuid.MustParse("47fee476-25b6-40bb-afa9-d755c9a021a5"): {
			CollectorNumber:  "107",
			ColorIdentity:    "BGRUW",
			Colors:           "BGRUW",
			Language:         Spanish,
		...
		uuid.MustParse("7dc3d054-6266-4ce0-89ed-f8b170794f2e"): {
			CollectorNumber:  "107",
			ColorIdentity:    "BGRUW",
			Colors:           "BGRUW",
			Language:         English,
